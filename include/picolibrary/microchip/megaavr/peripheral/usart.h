...
/**
 * \brief Microchip megaAVR Universal Synchronous Asynchronous Receiver Transciever
 *        (USART) peripheral.
 */
class USART {
  public:
...
/**
 * \brief Microchip megaAVR Universal Synchronous Asynchronous Receiver Transceiver
