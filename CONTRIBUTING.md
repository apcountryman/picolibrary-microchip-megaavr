# Contributing to picolibrary-microchip-megaavr
The following is a set of guidelines for contributing to `picolibrary-microchip-megaavr`.
...
- The `picolibrary-microchip-megaavr` version (Git commit SHA)
