...
/**
 * \file
 * \brief picolibrary::Microchip::AVR::megaAVR::GPIO::Open_Drain_IO_Pin toggle interactive
 *        test program.
 */

#include <avr-libcpp/delay>

#include "picolibrary/microchip/avr/megaavr/gpio.h"
...
using ::picolibrary::Microchip::AVR::megaAVR::GPIO::Open_Drain_IO_Pin;
using ::picolibrary::Testing::Interactive::GPIO::toggle;

} // namespace

/**
 * \brief Execute the picolibrary::Microchip::AVR::megaAVR::GPIO::Open_Drain_IO_Pin toggle
 *        interactive test.
 *
 * \return 0.
 */
