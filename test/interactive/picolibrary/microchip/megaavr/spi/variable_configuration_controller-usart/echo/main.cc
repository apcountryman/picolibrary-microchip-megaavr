...
/**
 * \file
 * \brief picolibrary::Microchip::megaAVR::SPI::Variable_Configuration_Controller<Peripheral::USART>
...
using ::picolibrary::Microchip::megaAVR::SPI::Variable_Configuration_Controller;
