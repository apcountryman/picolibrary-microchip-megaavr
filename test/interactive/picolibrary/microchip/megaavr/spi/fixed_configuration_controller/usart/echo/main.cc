...
/**
 * \file
 * \brief picolibrary::Microchip::megaAVR::SPI::Fixed_Configuration_Controller<picolibrary::Microchip::megaAVR::Peripheral::USART>
...
using Fixed_Configuration_Controller = ::picolibrary::Microchip::megaAVR::SPI::Fixed_Configuration_Controller<USART>;
...
int main()
{
    echo<Unbuffered_Output_Stream>(
        ...
        Fixed_Configuration_Controller{ CONTROLLER_USART::instance(),
